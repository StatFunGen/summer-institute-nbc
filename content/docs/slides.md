...
课程课件会随课程进度持续更新。正式课件准备好后，会替换本页对应的下载文件；如果当前下载文件为空，说明该课件仍在更新中，请以授课现场通知为准。
...
- 王告：课件文件二《精细定位、共定位与机器学习（ML）、人工智能（AI）新进展》：<a href="../slides/2026-06-23-wang-gao-02-finemapping-colocalization-ai.pdf">下载</a>
- 刘毓文：课件文件一《高通量功能基因组实验与复杂疾病研究》：<a href="../slides/2026-06-23-liu-yuwen-01-functional-genomics.pdf">下载</a>

## 6月24日 星期三

- 李扬：课件文件一《基因组学测量、质量控制与调控信号解读》：<a href="../slides/2026-06-24-li-yang-01-genomics-qc.pdf">下载</a>
- 李扬：课件文件二《调控数量性状位点（QTL）与疾病基因组》：<a href="../slides/2026-06-24-li-yang-02-qtl-disease-genomics.pdf">下载</a>
